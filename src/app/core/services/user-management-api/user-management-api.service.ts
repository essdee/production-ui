...
export class UserManagementApiService {
  ...
  async api_call(api_call_type:string, api_name:string, body?:any) {
    ...
    var api_dict: { [id: string]: string } = {
      ...
      'initiate_otp':
        '/api/method/user_management.user_management.doctype.cd_login_attempt.cd_login_attempt.initiate_otp',
      'verify_otp':
        '/api/method/user_management.user_management.doctype.cd_login_attempt.cd_login_attempt.verify_otp',
      'resend_otp':
        '/api/method/user_management.user_management.doctype.cd_login_attempt.cd_login_attempt.resend_otp',
      'get_reset_password_key':
        '/api/method/user_management.user_management.doctype.cd_login_attempt.cd_login_attempt.get_reset_password_key',
      'update_password':
